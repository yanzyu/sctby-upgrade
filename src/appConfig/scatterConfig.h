...
/* do not modify */
#define DESC_RO_BASE       APP_RO_BASE
#define DESC_RW_BASE       APP_RW_BASE
...
/* do not modify */
#define INIT_RO_BASE       DESC_RO_END
...
#endif
#if (((INIT_RO_BASE - BOOT_BASE) % 0x200) != 0)
...
/* do not modify */
#define BSW_RO_BASE     INIT_RO_END
#define BSW_RW_BASE     INIT_RW_END
